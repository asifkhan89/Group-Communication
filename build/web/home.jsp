                                ...
                                <td height="185" align="left" valign="top" >
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<%=request.getContextPath()%>/RecycleBean">Deleted Files</a>
                                            </td>
                                        </tr>
                                        <tr> 
                                            <td align="center" valign="top"><h3>Uploaded File List</h3>
                                                <table width="100%" border="0" cellpadding="4" cellspacing="0" bordercolordark="#FFFFFF" class="bodytext">                                                                                                                                                    
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center"><a href="<%=request.getContextPath()%>/DownloadFile?fid=<%=list.get(++i)%>">Download</a></td>
                                                        <td align="center"><a href="<%=request.getContextPath()%>/Delete?fid=<%=list.get(i)%>">Delete</a></td>
                                                    </tr>
                                                    <%++i;++i;}%>
                                                </table>
                                            </td>
